...
class AuthController extends GetxController {
  ...
  void addNewConnection(String friendEmail) async {
    ...
    CollectionReference lawyer = firestore.collection("lawyer");

    final docChats =
        await lawyer.doc(_currentUser!.email).collection("chats").get();

    if (docChats.docs.length != 0) {
      // user sudah pernah chat dengan siapapun
      final checkConnection = await lawyer
